 ...
 * @author Sudip_Maiti
 */
public class Working_list extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Working_list.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

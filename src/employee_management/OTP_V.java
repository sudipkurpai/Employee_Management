 ...
 * @author Sudip_Maiti
 */
public class OTP_V extends javax.swing.JFrame {
...
//        Close_b.setForeground(Color.red);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OTP_V.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
